<?php
    ...
    $bProdukD = $kueriMall->bProdukD($_GET['ip']); //Baca Detail Product //File di kueri-mall.php
    ...
    if (isset($_POST['edit_produk'])) {
         $a = $kueriMall->eProduk($_GET['ip'], $_POST['nama_produk'], $_POST['harga'], $_POST['deskripsi'], $_POST['berat'], $_POST['stok'],$_POST['kt']);
            if ($a == 'Berhasil') {
        ...
        //         $a = $kueriMall->iProduk($_GET['it'], $_POST['nama_produk'], $_POST['harga'], $_POST['deskripsi'], $_POST['berat'], $_POST['stok'],$_POST['kt'], $_POST['link_video'], $nama_baru1, $nama_baru2,$nama_foto_produk_s, $nama_foto_thumb_s,$tempat_upload, '@bestore-product');
        //         if ($a == 'Berhasil') {
        //             echo '<script>alert("Berhasil Memasukkan Produk"); window.location="product-list";</script>';
        //         }elseif ($a == "Gagal Upload Gambar") {
        //             echo '<script>alert("Gagal Upload Gambar"); </script>';
    ...
    <div class="breadcrumbs-dark pb-0 pt-4" id="breadcrumbs-wrapper">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col s6 m6 l6">
              <a class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn left" href="form-edit-thumb?ip=<?= $_GET['ip'] ?>">
                  <i class="material-icons hide-on-med-and-up">edit</i>
                  <span class="hide-on-small-onl">Edit Video Product</span>
              </a>
              <a class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right" href="form-edit-img?ip=<?= $_GET['ip'] ?>"">
                  <i class="material-icons hide-on-med-and-up">edit</i>
                  <span class="hide-on-small-onl">Edit Img Product</span>
              </a>
          </div>
        </div>
      </div>
                      ...
                      <form class="col s12" action="" method="post" enctype="multipart/form-data">
                        <div class="row">
                          <div class="input-field col m6 s12">
                            <input placeholder="Nama Product" id="" name="nama_produk" type="text" value="<?= $rowDp['nama_produk'] ?>">
                            <label for="date-demo1">Nama Product</label>
                          </div>
                          <div class="input-field col m6 s12">
                            <input placeholder="Harga" id="" name="harga" type="text" value="<?= $rowDp['harga'] ?>">
                            <label for="date-demo1">Harga Product</label>
                          </div>
                        </div>
                        <div class="row">
                          <div class="input-field col m6 s12">
                            <input placeholder="Gram" id="" name="berat" type="text" value="<?= $rowDp['berat'] ?>">
                        ...
                        <div class="row">
                          <div class="input-field col m6 s12">
                            <textarea id="textarea2" name="deskripsi" class="materialize-textarea"><?= $rowDp['deskripsi'] ?></textarea>
                            <label for="date-demo1">Deskripsi Product</label>
                          </div>
                          <div class="input-field col m6 s12">
                            <input placeholder="Pcs" id="" name="stok" type="text" value="<?= $rowDp['stok'] ?>">
                            <label for="date-demo1">Stok Produk</label>
                          </div>
                        </div>
                        <div class="row">
                            <div class="input-field col m6 s12 text-right">
                                <button class="btn waves-effect waves-light " type="submit" name="edit_produk">Edit
                        ...
                        <!-- <div class="row">
                          <div class="input-field col m6 s12">
                            <div class="file-field input-field">
                              ...
                              <div class="file-path-wrapper">
                                <input class="file-path validate" name="foto_produk" type="text">
                              </div>
                            </div>
                          </div>
                          <div class="input-field col m6 s12">
                          ...
                          <div class="row">
                            <div class="input-field col m6 s12">
                              <input placeholder="R-f3z7bV7sE" name="link_video" id="" type="text" value="">
