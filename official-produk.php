...
<head>
    ...
    <!-- Css This Page -->
    <link rel="stylesheet" href="assets/css/official-product.css">
    <!-- Css Font -->
                ...
                <div class="row bar-menu fixed-bottom">
                    <div class="col-12">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-2 text-center div-menu">
                                <a href="feed">
                                    <svg fill="#777" width="0.3000in" height="0.2800in" version="1.1" id="Capa_1"
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;"
                                        xml:space="preserve">
                                        <g>
                    ...
                    <div class="col-12">
                        <div class="row justify-content-around">
                            ...
                            <div class="col-2 text-right">
                                <a href="#">
                                    <svg fill="#F9C032" id="Capa_1" enable-background="new 0 0 512 512"
                                        height="0.2800in" viewBox="0 0 512 512" width="0.2800in"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <path
