<?php
    ...
    // Baca Toko
    $bToko = $kueriMall->bTokoD($rowDp['id_toko']);
    $rowToko = mysqli_fetch_assoc($bToko);

    $ProductToko = $kueriMall->bProdukPatnerKu($rowToko['id_penjual']);
    $hProduct = mysqli_num_rows($ProductToko);
    ...
    <div class="wrapper">
        ...
        <div id="content">
            <div class="container d-detail-product">
                ...
                <div class="row gallery-product">
                    <div class="swiper-container gallery-top mb-1">
                        <div class="swiper-wrapper">
                            <!-- Begin::Video Product -->
                            <div class="swiper-slide" style="display:<?= $hide ?>;">
                    ...
                    <div class="col-11">
                        ...
                        <div class="row">
                            <div class="col-10 price">
                                ...
                                <h4 class="c-k">Rp<?= number_format($rowDp['harga'],0,",",".")?></h4>
                                <div class="rate">
                                    <span>
                            ...
                            <div class="col-10">
                                ...
                                <form action="" method="post">
                                    <div class="row mt-3">
                                            ...
                                            <div class="col-6">
                                                <button type="submit" name="checkout" class="btn btn-addcart">
                ...
                <!-- Begin:PRODUCT LAINNYA -->
                <div class="row mb-5 justify-content-center card-ulasan" style="display:none;">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-12">
                                <div class="row pt-4">
