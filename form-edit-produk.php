<?php
    ...
    $jns_produk = $kueriMall->jnsProduk();
    ...
    if (isset($_POST['masukkan_produk'])) {
        ...
        if( ($format1 == "jpg") or ($format1 == "png") ){
            if (($format2 == "jpg") or ($format2 == "png")) {
                $a = $kueriMall->iProduk($_GET['it'], $_POST['nama_produk'], $_POST['harga'], $_POST['deskripsi'], $_POST['berat'], $_POST['stok'],$_POST['jns_produk'], $_POST['link_video'], $nama_baru1, $nama_baru2,$nama_foto_produk_s, $nama_foto_thumb_s,$tempat_upload);
                if ($a == 'Berhasil') {
                    ...
                    <div class="col-11">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="jns_produk" required="" id="exampleFormControlSelect1">
                                    <?php
                                        while ($rowJns = mysqli_fetch_assoc($jns_produk)) {
                                    ?>
                                    <option value="<?= $rowJns['id_jenis_produk']?>"><?= $rowJns['nama_jenis_produk']?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="form-group">
